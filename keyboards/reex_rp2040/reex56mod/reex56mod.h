...
#define LAYOUT( \
        ...
        L61, L62, L63,           L70,           R61,           R62, R63, R70, \
             LA2, LA3, L93, LB2, LB3,           RA2, RA3, R93, RB2, RB3 \
    ) \
    { \
        ...
        { L40,   L41,   L42,   KC_NO, KC_NO, KC_NO, KC_NO, L93 }, \
        { KC_NO, KC_NO, LA2,   LA3,   KC_NO, KC_NO, LB2,   LB3 }, \
        ...
        { R40,   R41,   R42,   KC_NO, KC_NO, KC_NO, KC_NO, R93 }, \
        { KC_NO, KC_NO, RA2,   RA3,   KC_NO, KC_NO, RB2,   RB3 } \
    }
